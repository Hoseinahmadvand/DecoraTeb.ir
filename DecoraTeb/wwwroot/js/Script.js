...
(function () {
    ...
    function goTo(index) {
        ...
        if (counter)
            counter.textContent = faNums[current];
...
// ================= Filter =================
const filterBtns =
    document.querySelectorAll('.filter-pills .btn');
...
// ================= Newsletter =================
document
    .querySelectorAll('.newsletter-band form')
    .forEach(form => {
        ...
        entries.forEach(e => {
            if (e.isIntersecting) {
                ...
                const timer = setInterval(() => {
                    ...
                    el.textContent = cur.toLocaleString('fa-IR');
                }, 25);
...
counters.forEach(c=> counterIO.observe(c));
    ...
    // Generic category filter (projects / blog)
